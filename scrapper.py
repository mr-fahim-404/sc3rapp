...
# Aiogram setup
BOT_TOKEN = "7216073274:AAEUmFvuzk9f-lmEIThMHae-6FUWuJ9vD7Y"   # Replace this BOT_TOKEN
bot = Bot(token=BOT_TOKEN)
dp = Dispatcher(bot)

# Pyrogram setup
api_id = "6342454"   # Replace this API ID with your actual API ID
api_hash = "3a730e2ea3e1f1aac71d268cc5244014"  # Replace this API ID with your actual API HASH
phone_number = "+8801838650690"    # Replace this API ID with your phone number
...
admin_ids = [1777017101, 1777017101]

default_limit = 5000  # Max limit for any user
